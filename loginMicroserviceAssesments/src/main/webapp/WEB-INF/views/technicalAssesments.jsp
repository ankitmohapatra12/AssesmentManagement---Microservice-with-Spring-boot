...
<body>
	<ul>
			  ...
			  <li><a class="active" href="/Employee/scheduleTechnicalAssesment">Technical Assesment Registration</a></li>
			  <li id="li4"><a href="/logout">LOGOUT</a></li>
			</ul>
			<body>
	<div class="form">

    <form class="register-form" action="/Employee/savetechnicalRegistration" method="post">
      <h3 style="color:#6D2AE2;margin-bottom:30px;">TECHNICAL ASSESSMENT REGISTRATION</h3>
